            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <a href="#deleteMultipleEmployeeModal" class="btn btn-danger delete-multiple" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete Selected</span></a>
                    </div>
                </div>
            </div>
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<a href='#editEmployeeModal' class='edit' data-id='" . $row['id'] . "' data-name='" . $row['name'] . "' data-email='" . $row['email'] . "' data-address='" . $row['address'] . "' data-phone='" . $row['phone'] . "' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Edit'>&#xE254;</i></a>";
...
<div id="deleteMultipleEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="delete_multiple_employees.php" method="post">
